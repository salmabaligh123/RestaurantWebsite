          ...
          <div class="container my-auto py-5">
            <div class="row">
              <div class="col-11 col-md-10 col-lg-9 col-xl-8 mx-auto">
                <h3 class="font-weight-300 text-9 mb-5">Enable/Disable Cashiers</h3>
                  ...
                  <table class="table table-bordered">
                    ...
                    ?>
                      <tr>
                        ...
                        ?>
                          <td><a href="thendisable.php?username=<?php echo $row['username']; ?>">Disable</a></td>
                        <?php
                        } else {
                        ?>
                          <td><a href="thenenable.php?username=<?php echo $row['username']; ?>">Enable</a></td>
                        <?php
                        }
