...
<head>
    ...
    <link rel="stylesheet" href="creidtcard.css">
    ...
    <form action="">
        ...
        <div class="flexbox">
            <div class="inputBox">
                ...
                <select name="expmm" id="" class="month-input" name="expmm">
            ...
            <div class="inputBox">
                ...
                <select name="" id="" class="year-input" name="expyy">
